...
namespace Oip.Security.EntityFramework.Configuration.PostgreSQL;
...
public static class DatabaseExtensions
{
        ...
        where TDataProtectionDbContext : DbContext, IDataProtectionKeyContext
    {
        ...
        // DataProtectionKey DB from existing connection
        services.AddDbContext<TDataProtectionDbContext>(options =>
            options.UseNpgsql(dataProtectionConnectionString, sql => sql.MigrationsAssembly(migrationsAssembly)));
    }
}